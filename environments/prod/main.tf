...
module "storage_source" {
  ...
  replication_type            = "GZRS" # Geo-zone redundant in prod
...
module "governance" {
  ...
  tag_policy_effect       = "Deny" # strict enforcement in prod
